...
export const getCount = () => async (dispatch) => {
    ...
    const url = "http://13.125.219.73:9000/cart/count";
    const data = { "id": id };
...
export const getCartList = () => async (dispatch) => {
    const id = localStorage.getItem("user_id");
    const url = "http://13.125.219.73:9000/cart/items";
    const data = { "id": id };
    const result = await axiosPost({ url, data });
...
export const updateCartList = (cid, type) => async (dispatch) => {
    const url = "http://13.125.219.73:9000/cart/updateQty";
...
export const deleteCartItem = (cid) => async (dispatch) => {
    const url = "http://13.125.219.73:9000/cart/deleteItem";
    const data = { "cid": cid };
...
export const saveToCartList = (cartItem) => async (dispatch) => {
    const url = "http://13.125.219.73:9000/cart/add";
    const id = localStorage.getItem("user_id");
...
export const clearCart =()=> async (dispatch) => {
    const id = localStorage.getItem("user_id");
    const url = "http://13.125.219.73:9000/cart/clear";
    const data = { "id": id };
    const result = await axiosDelete({ url, data });
